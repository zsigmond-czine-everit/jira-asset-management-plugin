package biz.everit.jira.assets.management.service.api;
...
public interface JiraPluginService extends InitializingBean {
    ...
    /**
     * Changing the issue summary. The change is only executed if the old and new summary is different and the new
     * summary is valid.
     * 
     * @param issueKey
     *            the key of the issue. Not be <code>null</code>.
     * @param issueSummary
     *            the summary of the issue (issue name). Not be <code>null</code> and not be empty or just only contains
     *            space.
     */
