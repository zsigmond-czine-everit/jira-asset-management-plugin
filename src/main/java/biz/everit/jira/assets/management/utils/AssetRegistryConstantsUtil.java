...
/**
 * The class defined the asset registry constants.
 */
public final class AssetRegistryConstantsUtil {
    ...
    /**
     * The name of the internal assigned status.
     */
    public static final String STATUS_INTERNAL_ASSIGNED_NAME = "Internal assigned";

    /**
     * The name of the external assigned status.
     */
    public static final String STATUS_EXTERNAL_ASSIGNED_NAME = "External assigned";
